...
type UserFollow struct {
	...
	// Relations
	UserFollowing User `gorm:"foreignKey:UserFollowingID;references:UserID"`
    UserFollowed  User `gorm:"foreignKey:UserFollowedID;references:UserID"`
}
...
type UserBlock struct {
	...
	// Relations
	UserBlocked  User `gorm:"foreignKey:UserBlockedID;references:UserID"`
	UserBlocking User `gorm:"foreignKey:UserBlockingID;references:UserID"`
}