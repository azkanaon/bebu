...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  try {
    // Tembak API untuk ambil judul asli buku
    const book = await booksService.getBookBySlug(slug)
    return {
      title: book.title, // Hasil: "Atomic Habits | Bebu"
    }
  } catch {
    return { title: 'Book Detail' }
  }
}
