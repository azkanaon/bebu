    ...
    <div className="w-full rounded-2xl bg-auth-form p-6 shadow-2xl ring-1 ring-white/5 sm:p-8 lg:my-10">
      ...
      <form className="space-y-5" onSubmit={handleSubmit}>
        ...
        <div className="grid grid-cols-2 gap-4">
          <button
            type="button"
            className="flex h-12 items-center justify-center gap-2 rounded-xl border border-white/5 cursor-pointer bg-[#161922] text-sm font-medium transition-all hover:bg-white/5"
          >
