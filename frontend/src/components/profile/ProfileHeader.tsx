            ...
            <AnimatePresence>
              {showOptions && (
                ...
                >
                  ...
                  <button className="w-full px-4 py-2.5 text-left text-sm flex items-center gap-3 hover:bg-white/5 text-gray-400 transition-colors cursor-pointer">
                    <Flag size={16} />
                    Report
                  </button>
                </motion.div>
            ...
            <div className="flex gap-6 text-sm text-gray-300">
              {viewerContext?.isOwnProfile && isPrivateAccount && (
                <motion.button
                  ...
                  className="relative w-8 h-8 rounded-full border border-white/10 bg-white/3 flex items-center justify-center hover:bg-white/6 transition-colors text-gray-300 hover:text-white cursor-pointer"
                >
                  <motion.div
                    whileHover={{ rotate: 8 }}
          ...
          <div className="flex flex-wrap gap-2 mt-3">
            {viewerContext?.isOwnProfile ? (
              <motion.button
                ...
                whileTap={{ scale: 0.97 }}
                transition={{ type: 'spring', stiffness: 300 }}
                className="bg-my px-4 py-1.5 rounded-full text-sm w-full sm:w-auto cursor-pointer hover:bg-ym"
              >
                Edit Profile
              </motion.button>
            ) : (
