											...
											<div className="space-y-6">
												<div className="flex gap-4 md:flex-col items-start">
													<div className="w-24 h-36 md:w-40 md:h-56 mx-auto relative shrink-0 shadow-2xl rounded-2xl overflow-hidden border border-white/10 bg-black/20">
														{/* 1. Komponen Pertama: Untuk Efek Background Blur */}
														<BookCover
															src={
																bookshelfInfo.coverImgUrl
															}
															title=""
															fill
															priority
															className="blur-lg opacity-50 object-cover" // Tambahkan class blur di sini
														/>

														{/* 2. Komponen Kedua: Untuk Gambar Utama di Depan */}
														<BookCover
															src={
																bookshelfInfo.coverImgUrl
															}
															...
															fill
															className="object-contain relative z-10" // Tambahkan class object-contain dan z-index di sini
														/>
													</div>
