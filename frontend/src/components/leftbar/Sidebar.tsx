...
export default function Sidebar({ user }: SidebarProps) {
  ...
  // Jika sedang buka pop-up /post/, paksa effectivePathname menggunakan rute asal
  // yang disimpan Next.js di dalam history.state.as (misalnya '/' atau '/books')
  ...
  return (
		<div className="h-screen w-68 bg-right-bar text-white flex flex-col justify-between py-5 ml-16">
			...
			<div className="px-4">
				...
				{/* NAVIGATION */}
				{/* Sekarang effectivePathname stabil sejak milidetik pertama klik */}
